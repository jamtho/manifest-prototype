...
- **Snapshot rows** (`mnf:SnapshotRow`) — each row is a point-in-time observation of a recurring entity. The same entity appears multiple times across releases. Within a single release, each entity key is unique.
